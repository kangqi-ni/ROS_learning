...
from object_detection_robot.msg import Pose
...
class Detector:
    ...
    def image_cb(self, data):
        ...
        # Publish pose information of cups
        if self.pose.id == "47":
    ...
    def object_predict(self,object_data, header, image_np,image):
        ...
        # Construct pose information
        self.pose.pos_x = obj.bbox.center.x
        self.pose.pos_y = obj.bbox.center.y
        self.pose.size_x = obj.bbox.size_x
        self.pose.size_y = obj.bbox.size_y
