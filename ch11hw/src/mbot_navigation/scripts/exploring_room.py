...
class ExploringMaze():
    def __init__(self):  
        rospy.init_node('exploring_room', anonymous=True)  
        ...
        rospy.loginfo("Starting exploring room")  
        
        # 初始位置
        start_location = Pose(Point(0, 0, 0), Quaternion(0.000, 0.000, 0.709016873598, 0.705191515089))  
 
        locations = []  
        locations.append(Pose(Point(3.1632580757141113, -2.8025896549224854, 0.000), Quaternion(0.000, 0.000, 0.709016873598, 0.705191515089)))     
        locations.append(Pose(Point(-4.607054233551025, -2.5414886474609375, 0.000), Quaternion(0.000, 0.000, 0.982775204878226, 0.18480502340726818)))   
