...
class ExploringMaze():
    def __init__(self):  
        ...
        locations.append(Pose(Point(3.4689526557922363, 7.917815208435059, 0.000),  Quaternion(0.000, 0.000, 0.2901988059564129, 0.9569663802984263)))  
        locations.append(Pose(Point(7.07252311706543, 7.351039886474609, 0.000),  Quaternion(0.000, 0.000, -0.540953851979867, 0.8410522754431761)))  
